...
{
	OnTriggered, /* 通过输入或者游戏事件触发能力 */
	OnGiven /* 在能力赋予给目标后立即触发该能力：One Time Off */
};
...
public:
	// 在MakeGameplayEffectSpecHandle后执行
	FActiveGameplayEffectHandle NativeApplyGameplayEffectSpecHandleToTarget(AActor* TargetActor, const FGameplayEffectSpecHandle& InSpecHandle) const;
